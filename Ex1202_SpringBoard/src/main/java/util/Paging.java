...
//-----그룹페이지처리 이전 --------------------------------------------------------------------------------------------		
		if(isPrevPage){
			...
			sb.append("'><img src='/dbs/resources/img/btn_prev.gif'/></a>");
		}
		else
			sb.append("<img src='/dbs/resources/img/btn_prev.gif'/>");
...
//-----그룹페이지처리 다음 ----------------------------------------------------------------------------------------------
		if(isNextPage){
			...
			sb.append("'><img src='/dbs/resources/img/btn_next.gif'/></a>");
		}
		else
			sb.append("<img src='/dbs/resources/img/btn_next.gif'/>");
//---------------------------------------------------------------------------------------------------------------------	    
